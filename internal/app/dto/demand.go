...
type DemandDocumentDTO struct {
	...
	SourceCreatedAt      *time.Time `json:"sourceCreatedAt" ts_type:"string"`
	SourcePaidAt         *time.Time `json:"sourcePaidAt" ts_type:"string"`
	Currency             string     `json:"currency"`
	AuthoritySnapshotAt  *time.Time `json:"authoritySnapshotAt" ts_type:"string"`
