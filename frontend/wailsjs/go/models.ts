export namespace main {
	...
	export class ArchivePreview {
	    extractDir: string;
	    csvFiles: string[];
	    dirs: service.ArchiveDirNode[];
	
	    static createFrom(source: any = {}) {
	        return new ArchivePreview(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.dirs = this.convertValues(source["dirs"], service.ArchiveDirNode);
	    }
...
export namespace model {
	...
	export class DispatchRecord {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.productId = source["productId"];
	        this.memberAddressId = source["memberAddressId"];
	        this.bigOrderId = source["bigOrderId"];
	        this.quantity = source["quantity"];
	        this.status = source["status"];
	        this.createdAt = this.convertValues(source["createdAt"], null);
	        this.updatedAt = this.convertValues(source["updatedAt"], null);
...
export namespace service {
	...
	export class ArchiveDirNode {
	    name: string;
	    fileCount: number;
	    children?: ArchiveDirNode[];
	
	    static createFrom(source: any = {}) {
	        return new ArchiveDirNode(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.children = this.convertValues(source["children"], ArchiveDirNode);
	    }
