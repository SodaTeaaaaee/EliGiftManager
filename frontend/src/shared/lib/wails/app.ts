...
export function importToWave(waveId: number, csvPath: string, templateId: number): Promise<void> {
  assertWailsRuntime()
...
export function updateDispatchQuantity(dispatchId: number, quantity: number): Promise<void> {
  assertWailsRuntime()
...
export function removeProductFromWave(waveId: number, productId: number): Promise<void> {
  assertWailsRuntime()
...
export function removeUserTag(productId: number, waveMemberId: number): Promise<void> {
  assertWailsRuntime()
...
export function listDispatchRecords(waveId = 0): Promise<main.DispatchRecordItem[]> {
  assertWailsRuntime()
...
export function removeMemberFromWave(waveId: number, memberId: number): Promise<void> {
  assertWailsRuntime()
