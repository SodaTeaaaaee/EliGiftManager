...
export const enUS: AppMessageSchema = {
  ...
  waveWorkspace: {
    ...
    exceptions: 'Personal entitlement exceptions',
    exceptionsHint:
      'No exception-list or instance-lookup binding exists yet, so this is the minimal form: add or delete by manually entering the entitlement instance ID; the list view lands with a later binding.',
