...
export const enUS: AppMessageSchema = {
  ...
  inbox: {
    ...
    duplicatesHint: 'Duplicate observations are shown for review only; decision actions land in a later wave.',
    issues: 'Parse Issues',
    alignToProduct: 'Align to Product',
    alignUnavailableHint: 'The inbox row view does not carry an alias ID yet, so rows cannot be aligned here',
