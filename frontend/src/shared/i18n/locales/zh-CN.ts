...
export const zhCN = {
  ...
  glossary: {
    ...
    identityStrategy: {
      ...
      order_scoped_provisional: { label: '订单范围临时身份', desc: '不按稳定平台身份识别客户；按来源订单创建临时客户档案。' },
    },
    ...
    documentType: {
      ...
      import_carrier_mapping: { label: '导入承运商映射', desc: '导入该平台承运商代码对照表的文档类型。' },
    },
    supplierOrderStatus: {
  ...
  waveWorkspace: {
    ...
    shipments: {
      ...
      import: {
        ...
        uploadHint: '选择工厂平台，再挑选发货回传表格（CSV / Excel）。导入使用该平台「导入供应商发货」的默认绑定。',
        pickFile: '选择文件',
        templateProfile: '工厂平台',
        templateProfilePlaceholder: '选择工厂平台',
        documentTypeNote: '文件种类：导入供应商发货（由本入口固定）',
        defaultBindingLoaded: '将使用默认绑定：{key}',
        defaultBindingMissing: '该工厂平台尚未绑定「导入供应商发货」默认模板，无法导入。请先在接入向导中配置。',
        templateDrivenMappingHint: '已选择工厂平台：将按该平台此文件种类的默认绑定解析并对账。',
        templateDrivenMappingDetail: '可直接进入预览并提交。本次导入不会改写默认绑定。',
        templateDrivenPreviewHint: '默认绑定导入不会在客户端预览解析行——提交后由后端返回逐行结果。',
  ...
  integrations: {
    title: '接入管理',
    subtitle: '添加平台，并为每种文件配置导入映射。内置快捷安装与自定义新建之后用法相同。',
    newIntegration: '新建',
    loading: '正在加载接入列表…',
    loadError: '加载接入列表失败',
    empty: {
      title: '还没有添加任何平台',
      description: '添加一个内置平台，或新建自定义平台。添加之后都可以在详情里配置文件种类。',
      action: '新建',
    },
    added: {
      title: '已添加的平台',
    ...
    builtins: {
      title: '可安装的内置',
      description: '一点即可加入，并带上默认映射。加进来之后与自定义平台用法相同。',
      install: '添加',
      installed: '已添加到平台列表。',
      bilibili: {
        name: 'B 站',
        description: '哔哩哔哩来源平台，带会员名单、零售单、承运商与回传的默认映射。',
      },
      rouzao: {
        name: '柔造',
        description: '工厂平台，带商品目录、发货回传与工厂订单导出的默认映射。',
      },
    },
    customCreate: {
      title: '新建自定义平台',
      displayName: '显示名称',
      displayNamePlaceholder: '例如 我的工坊',
      profileKey: '接入标识',
      profileKeyPlaceholder: '例如 workshop_1',
      surface: '来源平台还是工厂',
      factoryLabel: '工厂供应平台',
      factoryLabelPlaceholder: '例如 rouzao',
      submit: '创建',
      created: '平台已创建。',
      failed: '无法创建平台',
    },
    ...
    detail: {
      ...
      bindingsGroupedHint: '绑定按文件种类分组；日常导入使用每种文件的默认绑定。',
    },
    carrierMappings: {
      import: '导入承运商映射',
      importHint: '导入使用本平台「导入承运商映射」的默认绑定，不会改写模板。',
      defaultBindingMissing: '该平台尚未绑定「导入承运商映射」默认模板，无法导入。请先在接入向导中配置。',
      empty: '尚未配置承运商映射。',
      aliases: '别名',
  ...
  intakeWizard: {
    ...
    steps: {
      ...
      businessSurface: { title: '来源还是工厂', description: '这是来源平台还是工厂？会员名单与零售单是来源平台下的文件种类，不是两份接入档案。' },
      capabilities: { title: '能力配置', description: '开通本平台会碰到哪些文件种类，以及需要开启哪些履约能力。' },
      documentType: { title: '选择文件种类', description: '选择本次要配置的一种文件；上传样例、映射列，并设为该平台这种文件的默认模板。' },
      sampleUpload: { title: '上传样例文件', description: '为所选这一种文件上传表格样例（CSV / Excel），用于识别表头并完成列映射。' },
      confirm: { title: '确认', description: '确认为这一种文件绑定默认模板。' },
    },
    nav: {
      next: '下一步',
      back: '上一步',
    ...
    presets: {
      ...
      bilibili: { label: 'B 站', description: '哔哩哔哩来源平台。会员名单与零售单是开通后的文件种类，不是两份档案。' },
    ...
    businessSurface: {
      membership: { label: '会员权益', description: '这是文件种类，不是第二份接入档案：来源平台的会员权益名单。' },
      retail: { label: '零售订单', description: '这是文件种类，不是第二份接入档案：来源平台的零售订单。' },
      factory: { label: '工厂侧', description: '工厂商品目录、供应商发货回传或工厂订单导出，不走需求分诊。' },
    },
    platformKind: {
      source: {
        label: '来源平台',
        description: '一个平台一行。会员名单与零售单是它下面的两种文件，不是两份接入。',
      },
      factory: {
        label: '工厂',
        description: '一个工厂一行。商品目录、发货回传、工厂订单导出是不同文件，各配一次。',
      },
    },
    fileKinds: {
      introSource: '开通这个来源平台会碰到哪些文件。本次向导接下来只配你选的一种；另一种稍后继续。',
      introFactory: '开通这个工厂会碰到哪些文件。每种文件单独上传样例并映射，不要用一份表同时生成三套模板。',
      import_entitlement: { label: '会员权益名单', hint: '周期性会员名单导出，用于导入权益需求。' },
      import_sales_order: { label: '零售订单', hint: '零售商店订单导出，用于导入零售需求。' },
    },
    documentType: {
      pickHint: '选择本次要配置的一种文件。上传该种样例、映射列、并设为该平台这种文件的默认模板。',
      loopHint: '已为当前这种文件绑定默认模板。可继续选择另一种文件配置，或取消离开（平台会保留）。',
    ...
    sampleUpload: {
      ...
      factoryHint: '本次只配这一种工厂文件；目录 / 发货 / 导出请分别上传各自样例。',
      factoryOptional: '其它文件种类可稍后在本向导继续配置，或从接入详情重新运行向导。',
      singleTypeHint: '本次只映射这一种文件。工厂目录 / 发货 / 导出请分别走各自样例。',
    ...
    destFields: {
      ...
      export_recipient_name: { label: 'export.收件人姓名', tooltip: '导出列：收件人姓名。' },
      export_supplier_sku: { label: 'export.供应方 SKU', tooltip: '导出列：供应方 SKU。' },
      export_supplier_line_no: { label: 'export.供应方行号', tooltip: '导出列：供应方行号。' },
      export_product_id: { label: 'export.商品 ID', tooltip: '导出列：商品 ID。' },
      export_fulfillment_line_id: { label: 'export.履约行 ID', tooltip: '导出列：履约行 ID。' },
      carrier_internal_carrier_code: { label: 'carrier.内部承运商代码', tooltip: '本系统使用的内部承运商代码。' },
      carrier_external_carrier_code: { label: 'carrier.外部承运商代码', tooltip: '平台侧外部承运商代码。' },
      carrier_external_carrier_name: { label: 'carrier.外部承运商名称', tooltip: '平台侧外部承运商名称。' },
      carrier_aliases: { label: 'carrier.别名', tooltip: '该承运商的别名或备用代码。' },
      carrier_is_default: { label: 'carrier.是否默认', tooltip: '是否设为默认承运商映射。' },
      tracking_tracking_no: { label: 'tracking.物流单号', tooltip: '物流追踪号。' },
      tracking_carrier_code: { label: 'tracking.承运商代码', tooltip: '承运商代码。' },
      tracking_carrier_name: { label: 'tracking.承运商名称', tooltip: '承运商名称。' },
      tracking_external_shipment_no: { label: 'tracking.外部发货单号', tooltip: '工厂侧发货单号。' },
      tracking_third_party_order_no: { label: 'tracking.第三方单号', tooltip: '用于对账的第三方订单号。' },
      tracking_fulfillment_line_id: { label: 'tracking.履约行 ID', tooltip: '内部履约行 ID（若表内直接给出）。' },
      tracking_shipment_id: { label: 'tracking.发货单', tooltip: '发货单标识。' },
      tracking_item_id: { label: 'tracking.明细 ID', tooltip: '物流回传中的明细行标识。' },
      tracking_external_document_no: { label: 'tracking.外部单据号', tooltip: '来源平台订单号 / 外部单据号。' },
      tracking_external_line_no: { label: 'tracking.外部行号', tooltip: '外部行号。' },
    },
    capabilities: {
    ...
    confirm: {
      ...
      documentType: '文档类型',
      remapNotice: '本次只更新这一种文件的默认模板，平台本身的配置保持不变。',
      bindConflict: '模板已创建并绑定，但未能设为默认——该文档类型下已存在默认模板，当前后端暂不支持替换现有默认绑定。已创建但默认绑定降级。',
      bindFailed: '未能将映射模板绑定为该文件种类的默认模板。',
      configureAnother: '继续配置另一种文件',
      templatePartial: '这种文件的模板失败，平台仍可用。可稍后在接入详情中补齐模板。',
      templateAllFailed: '这种文件的映射模板创建失败。平台本身仍可用，请稍后重新运行向导或手动补齐模板。',
      thisFileOnly: '完成将只为这一种文件创建映射模板并设为默认绑定。',
      profileIsPlatform: '正在创建或确认的是平台本身，不是某一种表。',
  ...
  inbox: {
    ...
    importModal: {
      ...
      step1SelectProfile: '选择接入平台',
      step2PickFile: '选择表格文件（CSV / Excel）',
      step3Preview: '预览与确认',
      documentTypeLabel: '文件种类',
      documentTypePlaceholder: '选择本次导入的文件种类',
      ...
      warningCount: '{count} 条映射警告（值仍已导入，建议核对）',
      templateDrivenHint: '将使用该平台此文件种类的默认绑定导入。',
      overrideThisRunOnly: '下方映射仅覆盖本次导入，不会写回默认绑定。',
      templateLoaded: '已加载默认绑定：{key}',
      templateMissing: '该平台此文件种类尚无默认绑定，导入可能失败；请先在接入向导中配置。',
    },
    // 新增叶子（P4 单元 B）：手动录入表单字段，契约未预先声明，按规则同步补充并在 deviations 中标注。
    manualEntry: {
      title: '手动录入需求',
      profileLabel: '来源平台',
      profilePlaceholder: '选择来源平台',
      documentTypeLabel: '文件种类',
      documentTypePlaceholder: '选择权益或零售',
      sourceCustomerRef: '来源客户标识（可选）',
      sourceCustomerRefRequired: '来源客户标识',
  ...
  products: {
    ...
    catalogImport: {
      ...
      action: '导入商品目录',
      title: '导入商品目录',
      hint: '选择工厂平台，再挑选 ZIP（含图片）或 CSV / Excel。导入使用该平台「导入商品目录」的默认绑定，不会改写模板。',
      documentTypeNote: '文件种类：{type}（由本入口固定）',
      defaultBindingLoaded: '将使用默认绑定：{key}',
      defaultBindingMissing: '该工厂平台尚未绑定「导入商品目录」默认模板，无法导入。请先在接入向导中配置。',
      profilePlaceholder: '选择工厂平台',
